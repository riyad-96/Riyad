      ...
      <div className="mx-auto max-w-6xl flex-1">
        <div className="flex items-center justify-between">
          <button
            ...
            className="relative transition-colors md:text-lg pointer-fine:hover:text-neutral-500"
          >
          ...
          <nav className="flex">
            ...
            />
            <NavBtn text="package" onClick={() => scrollToSection('package')} />
            <NavBtn text="contact" onClick={() => scrollToSection('contact')} />
          </nav>
        </div>
      </div>
    </header>
